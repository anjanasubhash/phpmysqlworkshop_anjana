...
<form action = "q2_send_mail.php" method="POST">
    Name:
     <input type="text"  name="name" style="margin-left:25px;" required><br><br>
    Mail Id:
    <input type="email"  name="mail" style="margin-left:19px;" required><br><br>
...
if(@$_POST["submit"])
{
 ...
 $name = @$_POST["name"];
 $mailto = @$_POST["mail"];
 $adminmail= "anjanasubhash93@gmail.com";
 ...
 $headers = "From: anjanasubhash93@gmail.com";
